...
class App extends Component {
  ...
  // chooseDifficulty() {
  //   dollars = difficulty.value + this.state.dollars
  //   localStorage.setItem("dollars", this.state.dollars)
  // }
  ...
  getModification(step) {
    ...
    if (step.modifiers) {
      ...
      var dollars = this.state.dollars
      ...
      step.modifiers.map((modifier, i) => {
        ...
        switch (modifier.type) {
          ...
          case "health":
            ...
            break
          case "dollars":
            dollars = modifier.value + this.state.dollars
            break
          default:
            break
        }
      ...
      this.setState({strenght: strenght, health: health, dollars: dollars})
